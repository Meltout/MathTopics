...
\begin{document}
    ...
    \problem{
        Казваме, че матриците \( A \) и \( B \) комутират, ако \( AB = BA \). (първият, който ми изпрати думата \textit{комутират} на лично печели наргиле) Да се намерят всички матрици, които комутират с:
        \begin{enumerate}
          \item \( 
            \begin{bmatrix}
              1 & 0 \\
